...
本项目是一个基于 React + NestJS 的现代化管理平台模板，采用前后端分离架构，提供完整的用户认证、权限管理、部门管理、文章管理等功能，支持灵活的权限控制和模块化扩展。

## 功能特性

### 核心功能

- **用户管理**：完整的用户增删改查、密码加密、部门关联
...
| 模型             | 说明         | 关键特性                             |
| ---------------- | ------------ | ------------------------------------ |
| **Organization** | 部门         | 树状结构、软删除、自关联             |
| **Role**         | 角色         | 路由权限 (JSON)、软删除              |
| **User**         | 用户         | 密码加密、角色关联、部门关联、软删除 |
